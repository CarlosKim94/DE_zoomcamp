...
BUCKET_NAME = "homeowkr03-bucket"

# If you authenticated through the GCP SDK you can comment out these two lines
CREDENTIALS_FILE = "homework03-dezoomcamp-fb1bfa5cbafa.json"
...
def download_file(month):
    ...
    gz_path = os.path.join(DOWNLOAD_DIR, f"fhv_tripdata_2019-{month}.csv.gz")
    ...
    try:
        ...
        # Save compressed file exactly as-is
